...
const CardBidang = ({ content, name, img }) => {
  return (
    <div className="flex justify-between flex-col  pt-12 rounded-[20px]  max-w-80 md:mr-10 sm:mr-5 mr-0 my-5 feedback-card transition ease-in-out delay-150 duration-700 bg-white hover:text-[#101010]">
      <img
        src={img}
        alt="icons"
